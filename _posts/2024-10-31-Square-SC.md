...
module code_param
    ...
    parameter(hn = 2,hnn = hn/2,kn = 2e2 ,Un = 100,Umax = 1.0,kbt = 1e-5,delta_E = 1e-5,engcut = 100,sigma = 1e-5,delta_k = pi/kn)  ! hn: 哈密顿量维度
...
program main
    ...
    if(indcore.eq.0)then
        ...
        open(32,file = "delta-normal.dat")  ! 序参量
        do i0 = 1,Un
...
@everywhere function self_delta(U0::Float64)
    ...
    while diff_delta > diff_eps 
        ...
        delta_new = -U0 * delta_new * (pi/kn)^2
