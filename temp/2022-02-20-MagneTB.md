...
## 考虑SOC
 在上面的计算中都没有考虑到SOC，所以这里同样可以对Graphene来考虑SOC，其实唯一的变化就是在第一步基函数选择的时候，考虑两种不同的自旋
 
 ![png](/assets/images/Mma/magtb-9.png)

 其余的所有计算都是相同的，只不过这个时候可以看到，在**K**点处打开了能隙

![png](/assets/images/Mma/magtb-10.png)

![png](/assets/images/Mma/magtb-11.png)

![png](/assets/images/Mma/magtb-12.png)

![png](/assets/images/Mma/magtb-13.png)
