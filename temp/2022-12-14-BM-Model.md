...
$$
\begin{equation}
t_{\perp}\left(K_{1}+\mathbf{q}_{1}+\mathbf{G}_{1}\right)\simeq t_{\perp}\left(K_{1}+\mathbf{G}_{1}\right)
\end{equation}
$$
...
$$
\begin{equation}
T_{12}^{\alpha\beta}\left(\mathbf{q}_{1},\mathbf{q}_{2}\right)=T_{\mathbf{q}_{b}}^{\alpha\beta}\delta_{\mathbf{q}_{1}-\mathbf{q}_{2},-\mathbf{q}_{b}}+T_{\mathbf{q}_{tr}}^{\alpha\beta}\delta_{\mathbf{q}_{1}-\mathbf{q}_{2},-\mathbf{q}_{tr}}+T_{\mathbf{q}_{tl}}^{\alpha\beta}\delta_{\mathbf{q}_{1}-\mathbf{q}_{2},-\mathbf{q}_{tl}},\label{eq:Dirac_interlayer}
\end{equation}
$$

这里对于$n=1(b),2(tr),3(tl)$有$\left|K_{1}+\mathbf{g}_{1,n}\right|=\left|K\right|=4\pi/\left(3a\right)$，在上面的方程中，定义了

$$
\begin{equation*}
T_{\mathbf{q}_{n}}^{\alpha\beta}=\frac{t_{\perp}\left(\left|\text{K}\right|\right)}{A_{u.c.}}e^{i\mathbf{g}_{1,n}\cdot\mathbf{\tau}_{1,\alpha}}e^{-i\mathbf{g}_{2,n}\cdot\mathbf{\tau}_{2,\beta}}
\end{equation*}
$$
...
$$
\begin{align}
T_{\mathbf{q}_{b}} & =\frac{t_{\perp}\left(\left|\text{K}\right|\right)}{A_{u.c.}}\left[\begin{array}{cc}
1 & 1\\
1 & 1
\end{array}\right],\\
T_{\mathbf{q}_{tr}} & =\frac{t_{\perp}\left(\left|\text{K}\right|\right)}{A_{u.c.}}e^{-i\mathbf{g}_{1,2}\cdot\mathbf{\tau}_{0}}\left[\begin{array}{cc}
e^{i\phi} & 1\\
e^{-i\phi} & e^{i\phi}
\end{array}\right],\\
T_{\mathbf{q}_{tl}} & =\frac{t_{\perp}\left(\left|\text{K}\right|\right)}{A_{u.c.}}e^{-i\mathbf{g}_{1,3}\cdot\mathbf{\tau}_{0}}\left[\begin{array}{cc}
e^{-i\phi} & 1\\
e^{i\phi} & e^{-i\phi}
\end{array}\right],
\end{align}
...
$$
\begin{align}
\mathbf{q}_{b} & =\text{K}_{1}-\text{K}_{2},\label{eq:q_b}\\
\mathbf{q}_{tr} & =\text{K}_{1}+\mathbf{g}_{1,2}-\text{K}_{2}-\mathbf{g}_{2,2},\label{eq:q_tr}\\
\mathbf{q}_{tl} & =\text{K}_{1}+\mathbf{g}_{1,3}-\text{K}_{2}-\mathbf{g}_{2,3}.\label{eq:q_tl}
\end{align}
$$
...
$$
\begin{align}
\mathbf{q}_{b} & =\left|\Delta\text{K}\right|\left(0,-1\right),\\
\mathbf{q}_{tr} & =\left|\Delta\text{K}\right|\left(\frac{\sqrt{3}}{2},\frac{1}{2}\right),\\
\mathbf{q}_{tl} & =\left|\Delta\text{K}\right|\left(-\frac{\sqrt{3}}{2},\frac{1}{2}\right).
\end{align}
$$
...
$$
\begin{equation}
T_{21}^{\alpha\beta}\left(\mathbf{q}_{2},\mathbf{q}_{1}\right)=\left(T_{\mathbf{q}_{b}}^{\beta\alpha}\right)^{*}\delta_{\mathbf{q}_{2}-\mathbf{q}_{1},\mathbf{q}_{b}}+\left(T_{\mathbf{q}_{tr}}^{\beta\alpha}\right)^{*}\delta_{\mathbf{q}_{2}-\mathbf{q}_{1},\mathbf{q}_{tr}}+\left(T_{\mathbf{q}_{tl}}^{\beta\alpha}\right)^{*}\delta_{\mathbf{q}_{2}-\mathbf{q}_{1},\mathbf{q}_{tl}}.\label{eq:Dirac_interlayer_21}
\end{equation}
$$
...
$$
\begin{equation}
T_{12}^{\alpha\beta}\left(\mathbf{q}_{2},\mathbf{q}_{1}\right)=\frac{t_{\perp}\left(\left|\text{K}\right|\right)}{A_{u.c.}}\left\{ \left[\begin{array}{cc}
1 & 1\\
1 & 1
...
e^{-i\phi} & 1\\
e^{i\phi} & e^{-i\phi}
\end{array}\right]\right\} =\frac{3t_{\perp}\left(\left|\text{K}\right|\right)}{A_{u.c.}}\left[\begin{array}{cc}
0 & 1\\
0 & 0
...
$$
\begin{equation}
t_{\perp}=\frac{3t_{\perp}\left(\left|\text{K}\right|\right)}{A_{u.c.}}.
\end{equation}
$$
...
$$
\begin{equation}
t_{\perp}\left(\left|\text{K}\right|\right)\simeq0.58 ev\cdot A^2
\end{equation}
$$
...
$$
\begin{equation}
\tilde{T}_{12}^{\alpha\beta}\left(\mathbf{q}_{1},\mathbf{q}_{2}\right)=\tilde{T}_{\mathbf{q}_{b}}^{\alpha\beta}\delta_{\mathbf{q}_{1}-\mathbf{q}_{2},\mathbf{q}_{b}}+\tilde{T}_{\mathbf{q}_{tr}}^{\alpha\beta}\delta_{\mathbf{q}_{1}-\mathbf{q}_{2},\mathbf{q}_{tr}}+\tilde{T}_{\mathbf{q}_{tl}}^{\alpha\beta}\delta_{\mathbf{q}_{1}-\mathbf{q}_{2},\mathbf{q}_{tl}},
\end{equation}
$$
...
$$\begin{align}
\tilde{T}_{\mathbf{q}_{b}} & =\frac{t_{\perp}\left(\left|\text{K}\right|\right)}{A_{u.c.}}\left[\begin{array}{cc}
1 & 1\\
1 & 1
\end{array}\right],\\
\tilde{T}_{\mathbf{q}_{tr}} & =\frac{t_{\perp}\left(\left|\text{K}\right|\right)}{A_{u.c.}}e^{i\mathbf{g}_{1,2}\cdot\mathbf{\tau}_{0}}\left[\begin{array}{cc}
e^{-i\phi} & 1\\
e^{i\phi} & e^{-i\phi}
\end{array}\right],\\
\tilde{T}_{\mathbf{q}_{tl}} & =\frac{t_{\perp}\left(\left|\text{K}\right|\right)}{A_{u.c.}}e^{i\mathbf{g}_{1,3}\cdot\mathbf{\tau}_{0}}\left[\begin{array}{cc}
e^{i\phi} & 1\\
e^{-i\phi} & e^{i\phi}
\end{array}\right].
\end{align}
